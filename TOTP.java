...
public class TOTP {
        ...
        public static void main(String[] args) {
                ...
                String seed = "1468200114682001146814682001146820011468";
                // Seed for HMAC-SHA256 - 32 bytes
                String seed32 = "1468200114682001146814682001146820011468" +
                                "146820011468200114683132";
                ...
                // TOTP = HOTP (K, T), trong đó T là Số nguyên và đại diện cho số bước thời gian
                // giữa thời gian bộ đếm ban đầu T0 và thời gian Unix hiện tại.
                // Cụ thể hơn, T = (Thời gian Unix hiện tại - T0) / X, trong đó hàm tầng mặc
                // định được sử dụng trong tính toán.
                // Ví dụ, với T0 = 0 và Bước thời gian X = 30, T = 1 nếu thời gian Unix hiện tại
                // là 59 giây và T = 2 nếu thời gian Unix hiện tại là 60 giây.

                long T0 = 0;// T0 là thời gian Unix để bắt đầu đếm các bước thời gian (giá trị mặc định là
                            // 0, tức là kỷ nguyên Unix) và cũng là một tham số hệ thống.
                long X = 30000;// X đại diện cho bước thời gian tính bằng giây (giá trị mặc định X = 30 giây)
                               // và là một tham số hệ thống.
                long testTime[] = { 14L, 1468200114L, 1468200000L,
                                1234567890L, 1640000070L, 1640000070L };// MẢNG TRUYỀN VÀO ĐỂ TEST

                String steps = "0";// Tạo bước
                DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");// Tạo định dạng thời gian
                ...
                try {
                        ...
                        for (int i = 0; i < testTime.length; i++) {
                                ...
                                long T = (testTime[i] - T0) / X;// T là Số nguyên và đại diện cho số bước thời gian giữa
                                                                // thời gian bộ đếm ban đầu T0 và thời gian Unix hiện
                                                                // tại.
                                steps = Long.toHexString(T).toUpperCase();
                                while (steps.length() < 16)
                                        steps = "0" + steps; // Nhồi thêm cho đủ 16 bits
